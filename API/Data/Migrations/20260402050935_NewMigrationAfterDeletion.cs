...
{
    /// <inheritdoc />
    public partial class NewMigrationAfterDeletion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FatherNameUrdu = table.Column<string>(type: "TEXT", nullable: false),
                    FatherCnic = table.Column<string>(type: "TEXT", nullable: false),
                    FatherOccupation = table.Column<string>(type: "TEXT", nullable: false),
                    FatherQualification = table.Column<string>(type: "TEXT", nullable: false),
                    MotherName = table.Column<string>(type: "TEXT", nullable: false),
                    MotherNameUrdu = table.Column<string>(type: "TEXT", nullable: false),
                    MotherQualification = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    FullName = table.Column<string>(type: "TEXT", nullable: false),
                    FullNameUrdu = table.Column<string>(type: "TEXT", nullable: false),
                    BForm = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    DateOfBirthInWords = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    MarkOfIdentification = table.Column<string>(type: "TEXT", nullable: true),
                    HifzEQuran = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "accountant-id", null, "Accountant", "ACCOUNTANT" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_StudentId_SessionId",
                table: "Enrollments",
                columns: new[] { "StudentId", "SessionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Parents_FatherCnic",
                table: "Parents",
                column: "FatherCnic",
                unique: true);
